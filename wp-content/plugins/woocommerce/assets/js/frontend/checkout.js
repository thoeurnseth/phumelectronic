		...
		update_checkout_action: function( args ) {
			...
			wc_checkout_form.xhr = $.ajax({
				...
				success:	function( data ) {
					...
					// 2022-11-18 Fixed Order Amount in right panel in form checkout not update after apply or remove coupon
					jQuery('.amount .woocommerce-Price-amount.amount').html(jQuery('.order-total .woocommerce-Price-amount.amount').html());
				}
