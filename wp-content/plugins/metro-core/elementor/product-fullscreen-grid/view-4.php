<?php
/**
 * This file can be overridden by copying it to yourtheme/elementor-custom/product-fullscreen-grid/view-4.php
 * 
 * @author  RadiusTheme
 * @since   1.0
 * @version 1.0
...
<div class="rt-el-product-fullscreen-grid-1 product-fullscreen-grid-4">
