...
Do you have questions or issues with Order Notification for Telegram? Leave a comment in this post. Read [this tutorial](https://choplugins.com/en/blog/telegram-notification-woocommerce-tutorial)

== Screenshots ==

1. Admin settings
1. Notification in Telegram

== Changelog ==
= 1.0.1 =
* Fix: Warning Failed opening file PHP, Uncaught Error Class
