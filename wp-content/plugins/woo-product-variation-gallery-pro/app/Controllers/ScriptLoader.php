...
class ScriptLoader
{
    ...
    public function enqueue_scripts() {
        ...
        $thumbnail_position = apply_filters('rtwpvg_thumbnail_position', rtwpvg()->get_option('thumbnail_position', 'bottom'));
        ...
        wp_localize_script('rtwpvg', 'rtwpvg', apply_filters('rtwpvg_js_options', array(
            ...
            'enable_thumbnail_slide' => rtwpvg()->get_option('thumbnail_slide'),
    ...
    public function admin_enqueue_scripts() {
        ...
        if ((isset($_GET['post_type']) && $_GET['post_type'] == 'product') || $screen_id === 'product' || ((isset($_GET['page']) && $_GET['page'] == "wc-settings") && (isset($_GET['tab']) && $_GET['tab'] == "rtwpvg"))) {
            ...
            if (apply_filters('rtwpvg_disable_alpha_color_picker', false)) {
                ...
                wp_enqueue_script('wp-color-picker-alpha', rtwpvg()->get_assets_uri("/js/wp-color-picker-alpha{$this->suffix}.js"), array('wp-color-picker'), '2.1.3', true);
            }
