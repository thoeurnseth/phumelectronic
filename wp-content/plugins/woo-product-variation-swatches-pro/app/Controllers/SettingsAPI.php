...
class SettingsAPI
{
    ...
    public function plugin_action_links($links) {
        $new_links = array(
            ...
            '<a target="_blank" href="' . esc_url('https://www.radiustheme.com/how-to-setup-configure-woocommerce-product-variation-swatches-pro/') . '">' . esc_html__("Documentation", 'woo-product-variation-swatches') . '</a>'
        );
            ...
            <div class="rtwpvs-doc-wrapper rt-doc-wrapper">
                <div class="rt-doc-box">
                    ...
                    <div class="item-content">
                        ...
                        <a target="_blank"
                           href="https://www.radiustheme.com/how-to-setup-configure-woocommerce-product-variation-swatches-pro/"
