...
class RevoCheckOut
{
    ...
    public function __construct()
    {
        ...
        $templatePath = plugin_dir_path(__FILE__)."templates/revo-checkout-template.php";
        if (!copy($templatePath,$path."/revo-checkout-template.php")) {
            return 0;
        }
...
function add_checkout_page() {
    ...
    if($page == null || strpos($page->post_name,"revo-checkout") === false || $page->post_status != "publish") {
        ...
        update_post_meta( $page_id, '_wp_page_template', 'templates/revo-checkout-template.php' );
    }
