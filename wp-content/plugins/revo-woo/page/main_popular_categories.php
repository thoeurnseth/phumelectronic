                  ...
                  <tbody>
                    ...
                    foreach ($data_banner as $key => $value): ?>
                      <tr>
                        ...
                        <td class="text-capitalize"><?php echo $value->title ?></td>
                        <td>
                          <?php 
                                          ...
                                          <div class="panel-body">
                                              <div class="form-group">
                                                <div class="col-sm-12">
                                                  ...
                                                  <input type="text" name="title" value="<?php echo $value->title ?>" class="form-control"  placeholder="Input Title" required="" aria-required="true">
                                                    ...
                                                    <select name="categories[]" multiple data-plugin-selectTwo class="form-control populate" title="Please select Categories" required>
                                                      ...
                                                      <?php foreach ($categories_list as $categories): ?>
                                                        <option value="<?php echo $categories->id ?>"
                                                          ...
                                                          ?>
                                                          ><?php echo $categories->text ?></option>
                                                      <?php endforeach ?>
                                                    </select>
                                                  </div>
                                              </div>
