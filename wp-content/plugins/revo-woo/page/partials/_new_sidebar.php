        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                ...
                <ul class="nav nav-main mr-0">
                    ...
                    <li class="w-100 <?php echo $_GET['page'] == 'revo-post-splash-screen' ? 'nav-active' : '' ?>">
                        <a href="<?php echo admin_url( 'admin.php?page=revo-post-splash-screen', 'admin' ); ?>">
                            <i class="fa fa-mobile" aria-hidden="true"></i>
                            <span>Splash Screen</span>
                        </a>                        
                    </li>
					 <li class="w-100 <?php echo $_GET['page'] == 'revo-post-popular-search' ? 'nav-active' : '' ?>">
                        <a href="<?php echo admin_url( 'admin.php?page=revo-post-popular-search', 'admin' ); ?>">
