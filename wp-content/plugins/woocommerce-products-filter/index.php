...
define('WOOF_VERSION', '1.2.7');
//define('WOOF_VERSION', uniqid('1woof-')); //for dev only
...
final class WOOF {
    ...
    public function init() {
        ...
        if ($first_init != 1) {
            ...
            //activate ext by  defoult
            $activate = array('label', 'in_stock', 'by_onsales', 'meta_filter', 'url_request');
            if (!$this->show_notes) {
